...
class TrailingStopManager:
    ...
    - Exit if spread widens > threshold (default: 1.0σ)
    ...
    def __init__(
        ...
        Args:
            widening_threshold: Exit if spread widens by this many σ from entry
                              (default 1.0σ)
    ...
    def should_exit_on_trailing_stop(
        ...
        - If position entered at entry_z = 2.2 (long):
          ...
          - Current Z = 3.8 ↓ widening = |3.8| - |2.2| = 1.6σ
        ...
        - If position entered at entry_z = -2.0 (short):
          ...
          - Current Z = -3.5 ↓ widening = |-3.5| - |-2.0| = 1.5σ
        ...
        if widening > self.widening_threshold:
            exit_reason = (
                f"Trailing stop: spread widened {widening:.2f}σ from entry "
    ...
    def should_exit_on_tight_trailing_stop(
        ...
        - Profit = 2.2 - 1.0 = 1.2σ (profit!)
        - Use tighter threshold: e.g., 0.3σ (if widens 0.3σ from best, exit)
        ...
        if profit > profit_threshold:
            # Tighter threshold: 0.3σ (vs normal 1.0σ)
            tight_threshold = 0.3
            ...
            if widening_from_best > tight_threshold:
                exit_reason = (
                    ...
                    f"spread widened {widening_from_best:.2f}σ from best "
