...
class ConcentrationLimitManager:
    ...
    def add_position(
        self, pair_key: str, symbol1: str, symbol2: str, side: str, notional: float = 1.0
    ) -> tuple[bool, str | None]:
        """
    ...
    def remove_position(self, pair_key: str) -> None:
        ...
        logger.info("position_removed", pair=pair_key, symbol1=symbol1, symbol2=symbol2)

    def _calculate_exposure_if_added(self, symbol: str, direction: str, notional: float) -> float:
        """
    ...
    def _update_exposure(self, symbol: str, direction: str, notional: float, pair_key: str) -> None:
    ...
    def _remove_exposure(self, symbol: str, direction: str, notional: float, pair_key: str) -> None:
