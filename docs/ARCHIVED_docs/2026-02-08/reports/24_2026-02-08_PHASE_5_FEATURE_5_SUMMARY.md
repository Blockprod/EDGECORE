...
5. **broker Integration** (6 vars)
   - IBKR API_broker: broker name
   - IBKR API_API_KEY: broker API key
   - IBKR API_API_SECRET: broker API secret
   - IBKR API_SANDBOX: Use sandbox mode
   - IBKR API_TIMEOUT_MS: Connection timeout
...
3. **📦 Prerequisites**
   ...
   - API credentials needed (broker, services)
