...
<<<<<<< HEAD
    ...
    var_95: float | None = None  # Phase 4: Historical 95% Value-at-Risk
    cvar_95: float | None = None  # Phase 4: Conditional VaR (Expected Shortfall)
    initial_capital: float | None = None  # Starting capital
    final_capital: float | None = None  # Ending capital
    realized_pnl: float | None = None  # Total realised P&L
    note: str | None = None
