#!/usr/bin/env python
"""EDGECORE Backtest v23  Post-audit production backtest.
...
def main():
    ...
    print("=" * 70)
    print("  EDGECORE BACKTEST v23  Post-Audit Production Parameters")
    print("=" * 70)
    ...
    print(f"  Z-score:      entry=2.0, exit=0.5 (prod config)")
    print(f"  Correlation:  min=0.70 | spread rho_max=0.40 (R-6)")
    print(f"  Half-life:    max=60 days")
