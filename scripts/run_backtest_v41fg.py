...
def main():
    ...
    #  Mandatory Cython check + pre-warm 
    ...
    # (b) the PythonC boundary is warmed up and excluded from benchmarks.
    _CYTHON_KERNELS = (
