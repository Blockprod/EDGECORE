#!/usr/bin/env python
"""EDGECORE Backtest v31g -- v31d params + FIXED TimeStop (1.5×HL, cap=30).
...
ITERATION HISTORY:
  ...
  v31e: -1.44%, Sharpe -0.09, 50 trades, WR 60%,  PF 0.91, DD -9.0%
       (exit_z=0.3 HURT. time_stop BUG: 2.0×HL not 1.5×HL)
  v31f: (running) -- same as v31e but with FIXED time_stop

v31g = v31d params EXACTLY + only the time_stop fix:
  - Restores exit_z=0.5 (v31d value — exit_z=0.3 proved worse)
  - Restores stop_pct=0.07 (v31d value — 6% was too tight)
  - Restores max_half_life=60 (v31d value)
  - ONLY CHANGE: time_stop=1.5×HL, cap=30 (properly injected)
...
# Time stop — ONLY CHANGE from v31d
...
def main():
    ...
    print("  All other params: identical to v31d")
