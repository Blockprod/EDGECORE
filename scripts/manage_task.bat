...
start "EDGECORE Bot" cmd /k "chcp 65001 >nul && cd /d C:\Users\averr\EDGECORE_V1 && set EDGECORE_MODE=paper && set EDGECORE_ENV=dev && set IBKR_CLIENT_ID=5 && set PYTHONIOENCODING=utf-8 && C:\Users\averr\EDGECORE_V1\venv\Scripts\python.exe scripts\run_paper_tick.py --continuous"
