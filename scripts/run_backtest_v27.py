#!/usr/bin/env python
"""EDGECORE Backtest v27 — v22 params on 3-year recent window (2023-2026).
...
def main():
    ...
    print("=" * 70)
    print("  EDGECORE BACKTEST v27 — v22 Params on 3Y Recent Window")
    print("=" * 70)
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        f.write("EDGECORE Backtest v27 — v22 Params, 3Y Recent (2023-2026)\n")
        f.write(f"{'=' * 60}\n")
