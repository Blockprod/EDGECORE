...
v17d - Institutional R:R with per-sector FDR + z-score exits.
       ...
       3. Z-score stop at 3.5¤â (nat. stat-arb stop vs percentage)
       4. Circuit breaker HWM reset (no infinite loop)
       5. Multi-lookback (252 + 126): diverse discovery
       
       R:R FIX (v17ÔåÆv17d):
         entry_z=2.0 ÔåÆ 1.5¤â expected profit (2.0ÔåÆ0.5)
         z_stop=3.5  ÔåÆ 1.5¤â max loss (2.0ÔåÆ3.5)
         R:R = 1:1 ÔåÆ need only 50% WR to break even
