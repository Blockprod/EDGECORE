# ruff: noqa: UP031
#!/usr/bin/env python
"""EDGECORE v34c -- Surgical: BASE + XLK + MCD only (39 symbols).

XLK was the top performer (+0.41 dS, +1.93 dPF, +3 trades).
MCD was the best non-tech winner (+0.07 dS, +0.23 dPF, +1 trade).
No redundant tech names to avoid noisy inter-tech pairs.
"""
...
def main():
    print("=" * 75)
    print("  EDGECORE v34c -- Surgical: BASE + XLK + MCD")
    print("  Universe: %d symbols" % len(V34C_SYMBOLS))
