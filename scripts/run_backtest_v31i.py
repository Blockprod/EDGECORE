...
ITERATION HISTORY:
  ...
  v31h: +8.17%, Sharpe 1.31,  24 trades, WR 62.5%, PF 3.88, DD -1.79%
       (v30b universe + strict momentum + time_stop=1.5├ùHL)

v31i = v31h + lower barriers for more trade generation:
  - SAME v30b 37-symbol universe
  - SAME strict momentum
  - SAME time_stop=1.5├ùHL, cap=30d
  - LOWER entry_z=1.5 (was 1.8) ÔÇö more frequent entries
  - HIGHER FDR_q=0.30 (was 0.25) ÔÇö more pairs survive FDR
  - LOWER min_spread=0.20 (was 0.30) ÔÇö accept tighter spreads
...
ENTRY_Z = 1.5           # LOWER ÔÇö more entries (was 1.8)
EXIT_Z = 0.5            # v30b
ALLOC_PCT = 50.0        # v30b
HEAT = 3.0              # v30b
STOP_PCT = 0.07         # v30b
...
REDISCOVERY = 2         # v30b
MIN_SPREAD = 0.20       # LOWER ÔÇö accept tighter spreads (was 0.30)
...
# Weekly gate ÔÇö LOWER to allow more entries
