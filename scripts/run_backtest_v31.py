...
def main():
    ...
    print("  Universe:     117 symbols, 10 sectors + 15 ETFs")
    print("  Momentum:     lookback=20, weight=0.30, min_str=0.30")
    print("  Combiner:     zscore(0.70) + momentum(0.30)")
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write("Momentum: lookback=20, weight=0.30\n")
        f.write("Combiner: zscore(0.70) + momentum(0.30)\n")
