...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="EDGECORE Backtest v30 -- Adaptive Bidirectional Regime"
    )
    ...
    if total_return is not None and sharpe is not None:
        ...
        print(f"  Delta: Return {delta_ret:+.2%} | Sharpe {delta_sharpe:+.2f} | Trades {total_trades - v29_trades:+d}")
