...
def main():
    ...
    print("  0.1 Slippage: Almgren-Chriss (spread+impact+timing)")
    print("  0.2 Kelly:    1/4 Kelly, max 10%/pair, 25%/sector, 2x lev")
    print("  0.2 NAV stop: 0.75% of NAV per trade")
    print("  0.3 Events:   3-sigma gap detection, +/-3d blackout")
    print("  0.4 Borrow:   HTB gate, max 3% annual fee")
    ...
    print()
    print("  v32 result:   see metrics above")
    print("  Criterion:    PF > 1.5, Sharpe > 0.8")
    print("=" * 70)
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write("Phase 0: Almgren-Chriss + Kelly 1/4 + EventFilter + BorrowCheck\n")
        f.write(f"Elapsed: {elapsed:.1f}s\n\n")
        f.write(summary)
        f.write("\n\n--- v31h baseline ---\n")
        f.write("+8.17%, Sharpe 1.31, PF 3.88, WR 62.5%, 24 trades, DD -1.79%\n")
    print(f"\n[Saved] {out_path}")
