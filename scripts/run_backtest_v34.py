#!/usr/bin/env python
"""EDGECORE v34  Combined Universe Backtest.
...
#  v34 Universe: 54 symbols 
V34_SYMBOLS = [
    # === BASE (37) ===
    "SPY",
...
def main():
    print("=" * 75)
    print("  EDGECORE v34  Combined Universe Backtest")
    ...
    if improved:
        print("   v34 PASSES  adopt as new baseline")
    else:
        print("  ﯔ v34 FAILS  keep v32j as baseline")
