...
<<<<<<< HEAD
    ...
    def __init__(self, reestimation_frequency_days: int = 7, emergency_vol_sigma: float = 3.0):
        """
...
<<<<<<< HEAD
    ...
    def record_initial_beta(self, pair_key: str, beta: float, bar_time: datetime | None = None) -> None:
        """
...
<<<<<<< HEAD
        ...
        logger.info("hedge_ratio_recorded_initial", pair=pair_key, beta=round(beta, 4))

    def reestimate_if_needed(
        self, pair_key: str, new_beta: float, drift_tolerance_pct: float = 10.0, bar_time: datetime | None = None
...
<<<<<<< HEAD
        ...
        last_datetime, last_beta, last_is_stable, _last_drift = last_record
...
<<<<<<< HEAD
            ...
            logger.warning(
                "emergency_reestimate_pair_deprecated", pair=pair_key, reason=deprecation_reason, action="STOP_TRADING"
            )
    ...
    def get_deprecation_reason(self, pair_key: str) -> str | None:
