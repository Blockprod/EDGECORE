    ...
    def invalidate(self, pattern: Optional[str] = None) -> int:
        ...
        with self._lock:
            ...
            keys_to_delete = [
                ...
                if self._pattern_matches(k, pattern)
            ]
...
class CachedFunction:
    ...
    def __init__(self, cache_manager: CacheManager, ttl: Optional[float] = None):
        """
    ...
    def __call__(self, func: Callable) -> Callable:
        ...
        wrapper._cache_key_func = self._generate_key
...
class DashboardCache:
    ...
    def get_cached_dashboard(self, bypass: bool = False) -> Optional[Dict[str, Any]]:
    ...
    def get_cached_metric(self, metric_type: str, bypass: bool = False) -> Optional[Dict[str, Any]]:
        """Get cached metric."""
        key = f'metrics_{metric_type}'
