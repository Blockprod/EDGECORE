...
class TestSlackAlerterBasic:
    ...
    def test_custom_throttle_seconds(self):
        ...
        alerter = SlackAlerter(webhook_url="https://example.com", throttle_seconds=60)
    ...
    def test_send_alert_success(self, mock_post):
        ...
        success, reason = alerter.send_alert(level="ERROR", title="Test Error", message="Something went wrong")
...
class TestSlackAlerterThrottling:
    ...
    def test_duplicate_alert_throttled(self, mock_post):
        ...
        alerter = SlackAlerter(webhook_url="https://hooks.slack.com/test", throttle_seconds=2)

        # First alert
        success1, _reason1 = alerter.send_alert("ERROR", "Test", "msg1")
    ...
    def test_throttle_expires(self, mock_post):
        ...
        alerter = SlackAlerter(webhook_url="https://hooks.slack.com/test", throttle_seconds=1)
...
class TestSlackAlerterErrorHandling:
    ...
    def test_unexpected_error_handled(self, mock_post):
        ...
        alerter = SlackAlerter(webhook_url="https://hooks.slack.com/test")
        success, _reason = alerter.send_alert("INFO", "Test", "msg")
...
class TestSlackAlerterIntegration:
    ...
    def test_rapid_fire_alerts_throttled(self, mock_post):
        ...
        alerter = SlackAlerter(webhook_url="https://hooks.slack.com/test", throttle_seconds=5)
...
class TestSlackAlerterTimeoutConfig:
    ...
    def test_custom_timeout(self):
        ...
        alerter = SlackAlerter(webhook_url="https://hooks.slack.com/test", timeout_seconds=10)
    ...
    def test_timeout_passed_to_requests(self, mock_post):
        ...
        alerter = SlackAlerter(webhook_url="https://hooks.slack.com/test", timeout_seconds=15)
