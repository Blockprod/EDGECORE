...
class TestReconciliationDivergence:
    ...
    def test_create_divergence(self):
        ...
        div = ReconciliationDivergence(
            type="equity", severity="high", description="Mismatch", broker_value=100000.0, internal_value=99000.0
        )
    ...
    def test_divergence_has_timestamp(self):
        ...
        div = ReconciliationDivergence(
            type="position", severity="low", description="Test", broker_value=1.0, internal_value=1.0
        )
...
class TestPositionReconciliation:
    ...
    def test_positions_match_within_tolerance(self):
        ...
        reconciler = BrokerReconciler(
            internal_equity=100000.0, internal_positions=positions, position_tolerance_units=0.1
        )
...
class TestFullReconciliation:
    ...
    def test_full_reconciliation_equity_mismatch(self):
        ...
        report = reconciler.full_reconciliation(broker_equity=99000.0, broker_positions={}, broker_orders={})
    ...
    def test_full_reconciliation_stores_report(self):
        ...
        report = reconciler.full_reconciliation(broker_equity=100000.0, broker_positions={}, broker_orders={})
...
class TestRecoveryActions:
    ...
    def test_recovery_actions_equity_high_severity(self):
        ...
        reconciler.full_reconciliation(broker_equity=50000.0, broker_positions={}, broker_orders={})
