...
<<<<<<< HEAD
from datetime import datetime  # noqa: F401  # pyright: ignore[reportUnusedImport]
...
<<<<<<< HEAD
    ...
    def test_add_position_to_trailing_stop(self):
        ...
        mgr.add_position(symbol_pair="AAPL_MSFT", side="long", entry_z=2.2, entry_spread=0.5, entry_time=now)
...
<<<<<<< HEAD
    ...
    def test_get_position_info(self):
        ...
        mgr.add_position(symbol_pair="TEST_PAIR", side="short", entry_z=-1.8, entry_spread=-0.3, entry_time=now)
...
<<<<<<< HEAD
    ...
    def test_no_exit_when_spread_within_threshold(self):
        ...
        mgr.add_position(symbol_pair="PAIR_1", side="long", entry_z=2.2, entry_spread=0.5, entry_time=now)

        # Current Z = 2.8 -> widening = |2.8| - |2.2| = 0.6�� (< 1.0�� threshold)
        should_exit, reason = mgr.should_exit_on_trailing_stop(symbol_pair="PAIR_1", current_z=2.8)
    ...
    def test_exit_when_spread_widens_beyond_threshold(self):
        ...
        # Current Z = 3.8 -> widening = |3.8| - |2.2| = 1.6�� (> 1.0�� threshold)
        should_exit, reason = mgr.should_exit_on_trailing_stop(symbol_pair="PAIR_1", current_z=3.8)
...
<<<<<<< HEAD
    ...
    def test_short_position_trailing_stop(self):
        ...
        mgr.add_position(symbol_pair="PAIR_SHORT", side="short", entry_z=-2.0, entry_spread=-0.4, entry_time=now)

        # Current Z = -3.5 -> widening = |-3.5| - |-2.0| = 1.5�� (> 1.0��)
        should_exit, reason = mgr.should_exit_on_trailing_stop(symbol_pair="PAIR_SHORT", current_z=-3.5)
    ...
    def test_custom_widening_threshold(self):
        ...
        mgr.add_position(symbol_pair="TIGHT_STOP", side="long", entry_z=2.0, entry_spread=0.4, entry_time=now)

        # Widening = 0.6�� > 0.5�� threshold -> should exit
        should_exit, _ = mgr.should_exit_on_trailing_stop(symbol_pair="TIGHT_STOP", current_z=2.6)
        assert should_exit
    ...
    def test_nonexistent_pair_returns_false(self):
        ...
        should_exit, reason = mgr.should_exit_on_trailing_stop(symbol_pair="NONEXISTENT", current_z=2.5)
...
<<<<<<< HEAD
    ...
    def test_max_profit_tracking_long_position(self):
        ...
        mgr.add_position(symbol_pair="LONG_TRACK", side="long", entry_z=2.2, entry_spread=0.5, entry_time=now)
...
<<<<<<< HEAD
    ...
    def test_max_loss_tracking_long_position(self):
        ...
        mgr.add_position(symbol_pair="LONG_LOSS", side="long", entry_z=2.2, entry_spread=0.5, entry_time=now)
...
<<<<<<< HEAD
    ...
    def test_tight_stop_not_triggered_out_of_profit(self):
        ...
        mgr.add_position(symbol_pair="NO_PROFIT", side="long", entry_z=2.2, entry_spread=0.5, entry_time=now)

        # Wider, not in profit yet (< 0.5�� profit)
        should_exit, _ = mgr.should_exit_on_tight_trailing_stop(
            symbol_pair="NO_PROFIT", current_z=2.5, profit_threshold=0.5
        )
    ...
    def test_tight_stop_triggered_for_profitable_position(self):
        ...
        mgr.add_position(symbol_pair="PROFIT_TRADE", side="long", entry_z=2.2, entry_spread=0.5, entry_time=now)

        # Move to profit: Z = 1.0 (profit = 2.2 - 1.0 = 1.2��)
        mgr.should_exit_on_trailing_stop("PROFIT_TRADE", 1.0)

        # Now widen from best: current = 1.4 (0.4�� from best)
        # Tight threshold = 0.3��, so should trigger
        should_exit, _ = mgr.should_exit_on_tight_trailing_stop(
            symbol_pair="PROFIT_TRADE", current_z=1.4, profit_threshold=0.5
        )
...
<<<<<<< HEAD
    ...
    def test_remove_position_manually(self):
        ...
        mgr.add_position(symbol_pair="REMOVE_ME", side="long", entry_z=2.0, entry_spread=0.4, entry_time=now)
    ...
    def test_get_active_positions(self):
        ...
        for i in range(3):
            mgr.add_position(symbol_pair=f"PAIR_{i}", side="long", entry_z=2.0, entry_spread=0.4, entry_time=now)
...
class TestTrailingStopRealisticScenarios:
    ...
    def test_scenario_partial_mean_reversion(self):
        ...
        assert reason is not None and "widened" in reason.lower()
    ...
    def test_scenario_immediate_widening(self):
        ...
        should_exit, reason = mgr.should_exit_on_trailing_stop("BAD_ENTRY", current_z=-3.0)

        assert should_exit
        assert reason is not None and "-3.0" in reason
...
<<<<<<< HEAD
    ...
    def test_very_tight_threshold(self):
        ...
        # Small widening: 0.3�� > 0.2�� -> should exit
=======
