...
<<<<<<< HEAD
from backtests.runner import COMMISSION_BPS, SLIPPAGE_BPS, TOTAL_COST_FACTOR, BacktestRunner
=======
...
<<<<<<< HEAD
        ...
        # Gross P&L: 1% of position (for documentation only)
        _ = (exit_price - entry_price) * 10  # 10 USD on 1000 notional
