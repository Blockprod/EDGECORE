...
class TestOrderLifecycleManagerInit:
    ...
    def test_init_with_custom_values(self):
        ...
        manager = OrderLifecycleManager(default_timeout_seconds=600.0, check_interval_seconds=20.0, max_retries=5)
...
class TestOrderCreation:
    ...
    def test_create_order_basic(self):
        ...
        lifecycle = manager.create_order(order_id="order_1", symbol="BTC/USD", quantity=1.0, price=50000.0)
    ...
    def test_create_order_with_custom_timeout(self):
        ...
        lifecycle = manager.create_order(
            order_id="order_1", symbol="BTC/USD", quantity=1.0, price=50000.0, timeout_seconds=600.0
        )
    ...
    def test_create_order_invalid_quantity(self):
        ...
        with pytest.raises(ValueError):
            manager.create_order(order_id="order_1", symbol="BTC/USD", quantity=-1.0, price=50000.0)
    ...
    def test_create_order_invalid_price(self):
        ...
        with pytest.raises(ValueError):
            manager.create_order(order_id="order_1", symbol="BTC/USD", quantity=1.0, price=0.0)
...
class TestTimeoutDetection:
    ...
    def test_timeout_action_includes_remediation(self):
        ...
        _expired, actions = manager.check_for_timeouts()
...
class TestForceClose:
    ...
    def test_force_close_order(self):
        ...
        success, _message = manager.force_close_order(
...
class TestOrderStatistics:
    ...
    def test_order_statistics_mixed_status(self):
        ...
        _order1 = manager.create_order("order_1", "BTC/USD", 1.0, 50000.0)
        _order2 = manager.create_order("order_2", "ETH/USD", 10.0, 2000.0)
...
class TestOrderCleanup:
    ...
    def test_cleanup_resolved_orders(self):
        ...
        lifecycle.last_update = datetime.now(UTC) - timedelta(seconds=3700)
    ...
    def test_cleanup_keep_recent_orders(self):
        ...
        _removed = manager.cleanup_resolved_orders(older_than_seconds=3600.0)
...
class TestOrderLifecycleIntegration:
    ...
    def test_timeout_and_force_close_workflow(self):
        ...
        # Check for timeouts
        expired, _actions = manager.check_for_timeouts()
        assert len(expired) > 0

        # Force close
        success, _message = manager.force_close_order("order_1", close_price=49900.0, close_quantity=0.5)
        assert success
