...
>>>>>>> origin/main
        ...
        def risk_callback(_sym, _size, _price, _equity):  # mirrors BacktestEngineWrapper callback signature
            return True

        # Run backtest
        results = engine.run(prices, symbols, strategy_callback, risk_callback)
...
<<<<<<< HEAD
        ...
        def strategy_callback(
            _price_vec, day
        ):  # mirrors BacktestEngineWrapper callback signature — price_vec unused in this stub
            if day == 0:
                return [
                    {
                        "symbol": "AAPL",
...
>>>>>>> origin/main
    ...
    def test_empty_prices(self):
        ...
        def strategy_callback(_price_vec, _day):  # mirrors callback signature — unused in this stub
            return []
...
>>>>>>> origin/main
    def test_find_cointegration_empty(self):
        ...
        results = engine.find_cointegration_parallel([], np.array([]).reshape(0, 0))
        assert results == []
...
>>>>>>> origin/main
        ...
        results = engine.find_cointegration_parallel(symbols, prices, max_half_life=60, min_correlation=0.5)
    ...
    def test_cointegration_parameters(self):
        ...
        results_strict = engine.find_cointegration_parallel(
            symbols, prices, max_half_life=10, min_correlation=0.9, pvalue_threshold=0.01
        )

        # Relaxed parameters
        results_relaxed = engine.find_cointegration_parallel(
            symbols, prices, max_half_life=60, min_correlation=0.5, pvalue_threshold=0.1
        )
...
>>>>>>> origin/main
    def test_performance_with_many_symbols(self):
        ...
        results = engine.find_cointegration_parallel(symbols, prices, max_half_life=60)
