...
<<<<<<< HEAD
    ...
    def test_reestimate_stable_drift(self):
        ...
        tracker.pair_betas["AAPL_MSFT"][0] = (datetime.now() - timedelta(days=40), 2.5, True, None)
...
<<<<<<< HEAD
        ...
        DynamicSpreadModel(y, x, half_life=20.0, pair_key="X_Y", hedge_ratio_tracker=tracker)
...
<<<<<<< HEAD
    ...
    def test_stable_pair_over_months(self):
        ...
        tracker.pair_betas["AAPL_MSFT"][0] = (datetime.now() - timedelta(days=30), 2.0, True, None)
        _b1, s1 = tracker.reestimate_if_needed("AAPL_MSFT", 2.02, drift_tolerance_pct=10.0)
        assert s1 is True
...
<<<<<<< HEAD
        ...
        _b2, s2 = tracker.reestimate_if_needed("AAPL_MSFT", 2.04, drift_tolerance_pct=10.0)
        assert s2 is True
    ...
    def test_degrading_pair(self):
        ...
        tracker.pair_betas["AAPL_MSFT"][0] = (datetime.now() - timedelta(days=30), 2.0, True, None)
        _b1, s1 = tracker.reestimate_if_needed("AAPL_MSFT", 2.06)
        assert s1 is True
...
<<<<<<< HEAD
        ...
        _b2, s2 = tracker.reestimate_if_needed("AAPL_MSFT", 2.31, drift_tolerance_pct=10.0)
