...
=======
        ...
        # Create test data
        z_scores_dict = {
            f'pair_{i}': pd.Series(np.random.randn(lookback))
...
=======
    ...
    def test_performance_optimizer_full_workflow(self):
        ...
        gen = opt.get_signal_generator()
        z_scores = {
            f'pair_{i}': pd.Series([float(i) * 0.5, float(i) * 0.7, float(i)])
            for i in range(10)
        }
...
=======
    ...
    def test_signal_generation_performance_target(self):
        ...
        # 50 pairs
        z_scores = {
            f'pair_{i}': pd.Series(np.random.randn(250))
            for i in range(50)
        }
        active = {f'pair_{i}': i % 2 == 0 for i in range(50)}
    ...
    def test_z_score_computation_performance(self):
        ...
        spreads = {
            f'pair_{i}': pd.Series(np.random.randn(252))
            for i in range(50)
        }
